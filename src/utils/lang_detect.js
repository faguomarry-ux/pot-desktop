...
import { translateMicrosoft } from './microsoft-translate.js';
...
async function bing_detect(text) {
    ...
    const result = await translateMicrosoft(text, 'auto', 'zh-Hans');
    return lang_map[result.detectedLanguage?.language] ?? 'en';
}
